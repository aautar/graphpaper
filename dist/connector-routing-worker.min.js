...
var computeConnectorPath=function computeConnectorPath(a,b,c){var d=Point.fromArray(a.anchor_start_centroid_arr),e=Point.fromArray(a.anchor_end_centroid_arr),f=a.marker_start_size,g=a.marker_end_size,h=a.curvature_px,i=b.findDistanceToPointClosestTo(d),j=b.findPointsCloseTo(d,i).findPointClosestTo(e),k=b.findPointsCloseTo(e,i).findPointClosestTo(d),l=c.computeRoute(j,k),m=l.toArray(),n=d,o=e;if(0<f&&1<=m.length){var q=new Line(m[0],d).createShortenedLine(0,f);n=q.getEndPoint();}if(0<g&&1<=m.length){var r=new Line(m[m.length-1],e).createShortenedLine(0,g);o=r.getEndPoint();}var p=[n].concat(_toConsumableArray(m),[o]);return{svgPath:SvgPathBuilder.pointsToPath(p,h),pointsInPath:p}}; var convertArrayBufferToFloat64Array=function convertArrayBufferToFloat64Array(a){return new Float64Array(a)};onmessage=function onmessage(a){var b={overallTime:null},c=new Date,d=a.data.gridSize,e=a.data.connectorDescriptors,f=new PointSet(convertArrayBufferToFloat64Array(a.data.routingPoints)),g=new LineSet(convertArrayBufferToFloat64Array(a.data.boundaryLines)),h=new PointSet(convertArrayBufferToFloat64Array(a.data.routingPointsAroundAnchor)),i=new PointVisibilityMap(f,g);e.forEach(function(a){var b=computeConnectorPath(a,h,i),c=new PointSet(b.pointsInPath);a.svgPath=b.svgPath, a.pointsInPath=c.toFloat64Array().buffer;}), b.overallTime=new Date-c, b.numRoutingPoints=f.count(), b.numBoundaryLines=g.count(), postMessage({connectorDescriptors:e,metrics:b});};
