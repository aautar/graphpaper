var GraphPaper = (function (exports) {
    ...
    function ConnectorAnchor(a,b,c){var d=this,e=["top","left","bottom","right"],f=function getDimensions(){var a=c.transformDomRectToPageSpaceRect(b.getBoundingClientRect());return new Point(a.getWidth(),a.getHeight())},g=function routingPointDirectionToPoint(a,b,c,d,e){return "top"===a?new Point(b.getX(),b.getY()-d-e):"bottom"===a?new Point(b.getX(),b.getY()+d+e):"left"===a?new Point(b.getX()-c-e,b.getY()):"right"===a?new Point(b.getX()+c+e,b.getY()):null};this.setPossibleRoutingPointDirections=function(a){e=a;},this.getId=function(){return a},this.getX=function(){return d.getCentroid().getX()},this.getY=function(){return d.getCentroid().getY()},this.getWidth=function(){var a=c.transformDomRectToPageSpaceRect(b.getBoundingClientRect());return a.getWidth()},this.getHeight=function(){var a=c.transformDomRectToPageSpaceRect(b.getBoundingClientRect());return a.getHeight()},this.getCentroid=function(){var a=c.getSheetOffset(),d=c.transformDomRectToPageSpaceRect(b.getBoundingClientRect()),e=.5*d.getWidth(),f=.5*d.getHeight();return new Point(d.getLeft()+e-a.getX(),d.getTop()+f-a.getY())},this.getRoutingPoints=function(a){var b=f(),c=d.getCentroid(),h=.5*b.getX(),i=.5*b.getY(),j=[];return e.forEach(function(b){j.push(g(b,c,h,i,a));}),j},this.getBoundingRectange=function(){var a=f(),b=d.getCentroid(),c=.5*a.getX(),e=.5*a.getY();return new Rectangle(b.getX()-c,b.getY()-e,b.getX()+c,b.getY()+e)};}
