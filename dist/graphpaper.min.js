...
function GroupTransformationContainer(a,b,c,d){var f=this,g=new Map,h=a.calcBoundingRectForObjects(b),j=0,k=0,l=h.getLeft(),m=h.getTop(),n=[];b.forEach(function(a){var b={x:a.getX()-l,y:a.getY()-m};n.push(b);}), "undefined"==typeof c&&(c="1px solid rgb(158, 158, 158)"), "undefined"==typeof d&&(d="rgba(153, 153, 153, 0.5)");var o=window.document.createElement("div");o.style.display="block", o.style.position="absolute", o.style.left=`${l}px`, o.style.top=`${m}px`, o.style.width=`${h.getWidth()}px`, o.style.height=`${h.getHeight()}px`, o.style.border=c, o.style.backgroundColor=d, this.getContainerDomElement=function(){return o}, this.getObjects=function(){return b}, this.translateByOffset=function(a,c){j+=a, k+=c, l=canvas.snapToGrid(h.getLeft()+j), m=canvas.snapToGrid(h.getTop()+k), o.style.left=`${l}px`, o.style.top=`${m}px`;for(var f=0;f<b.length;f++){var d=b[f],e=n[f];d.translate(canvas.snapToGrid(l+e.x),canvas.snapToGrid(m+e.y));}}, this.endTranslate=function(){j=0, k=0, h=a.calcBoundingRectForObjects(b);}, this.initTranslateInteractionHandler=function(){o.addEventListener("touchstart",p), o.addEventListener("mousedown",q);}, this.on=function(a,b){var c=g.get(a)||[];c.push(b), g.set(a,c);}, this.off=function(a,b){for(var c=g.get(a)||[],d=0;d<c.length;d++)if(c[d]===b){c.splice(d,1);break}g.set(a,c);};var p=function translateTouchStartHandler(a){var b=g.get(GroupTransformationContainerEvent.TRANSLATE_START)||[];b.forEach(function(b){b({container:f,x:a.touches[0].pageX,y:a.touches[0].pageY,isTouch:!0});});},q=function translateMouseDownHandler(a){var b=g.get(GroupTransformationContainerEvent.TRANSLATE_START)||[];b.forEach(function(b){b({container:f,x:a.pageX,y:a.pageY,isTouch:!1});});};}
