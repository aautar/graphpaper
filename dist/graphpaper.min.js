...
function Connector(a,b,c,d,e){var f=this,g=new Map,h={CLICK:"connector-click"};"undefined"==typeof d&&(d="#000"), "undefined"==typeof e&&(e="2px");var i=null,j=window.document.createElementNS("http://www.w3.org/2000/svg","path");j.setAttribute("d","M0 0 L0 0"), j.style.stroke=d, j.style.strokeWidth=e, j.addEventListener("click",function(a){var b=g.get(h.CLICK)||[];b.forEach(function(b){b({connector:f,clickedAtX:a.pageX,clickedAtY:a.pageY});});});var k=null;this.appendPathToContainerDomElement=function(){k=c.appendChild(j);}, this.getPathPoints=function(){return i}, this.refresh=function(a,b){i=b, j.setAttribute("d",a);}, this.getId=function(){var c=[a.getId(),b.getId()].sort();return c.join(":")}, this.getAnchorStart=function(){return a}, this.getAnchorEnd=function(){return b}, this.removePathElement=function(){j.remove();}, this.addClassToDomElement=function(a){j.classList.add(a);}, this.removeClassFromDomElement=function(a){j.classList.remove(a);}, this.getDescriptor=function(){return{id:f.getId(),anchor_start_centroid:a.getCentroid().toString(),anchor_end_centroid:b.getCentroid().toString()}}, this.on=function(a,b){var c=g.get(a)||[];c.push(b), g.set(a,c);}, this.off=function(a,b){for(var c=eventHandlers.get(a)||[],d=0;d<c.length;d++)if(c[d]===b){c.splice(d,1);break}eventHandlers.set(a,c);};}
