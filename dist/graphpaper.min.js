var GraphPaper = (function (exports) {
    ...
    var AccessibleRoutingPointsFinder={find:function find(a,b,c){var d=new Map,e=[],f=[];return a.forEach(function(a){var b=a.getConnectorAnchors();b.forEach(function(a){{var f=a.getRoutingPoints(c);f.forEach(function(b){e.push({routingPoint:b,parentAnchor:a});}),d.set(a.getId(),f.length);}});}),e.forEach(function(a){for(var c=!1,e=0;e<b.length;e++){var g=b[e],h=g.getBoundingRectange();if(h.checkIsPointWithin(a.routingPoint)){c=!0;var j=d.get(a.parentAnchor.getId())||0;d.set(a.parentAnchor.getId(),j-1);}}c||f.push(a.routingPoint);}),{connectorAnchorToNumValidRoutingPoints:d,accessibleRoutingPoints:f}}};
    ...
    function Connector(a,b,c,d,e,f,g,h){var j=this,k=new Map,l=0,m=0;"undefined"==typeof d&&(d="#000"),"undefined"==typeof e&&(e="2px"),"undefined"==typeof f&&(f=0),"undefined"==typeof g&&(g=!0),"undefined"==typeof h&&(h=ConnectorRoutingAlgorithm.ASTAR);var n=null,o=window.document.createElementNS("http://www.w3.org/2000/svg","path");o.setAttribute("d","M0 0 L0 0"),o.style.stroke=d,o.style.strokeWidth=e,o.addEventListener("click",function(a){j.dispatchEvent(ConnectorEvent.CLICK,{connector:j,clickedAtX:a.pageX,clickedAtY:a.pageY});}),o.addEventListener("mouseenter",function(a){j.dispatchEvent(ConnectorEvent.MOUSE_ENTER,{connector:j,pointerAtX:a.pageX,pointerAtY:a.pageY});}),o.addEventListener("mouseleave",function(a){j.dispatchEvent(ConnectorEvent.MOUSE_LEAVE,{connector:j});});var p=null;this.appendPathToContainerDomElement=function(){p=c.appendChild(o);},this.setMarkerStart=function(a,b){o.setAttribute(`marker-start`,`url(${a})`),l=b;},this.unsetMarkerStart=function(){o.removeAttribute(`marker-start`),l=0;},this.setMarkerEnd=function(a,b){o.setAttribute(`marker-end`,`url(${a})`),m=b;},this.unsetMarkerEnd=function(){o.removeAttribute(`marker-end`),m=0;},this.getPathPoints=function(){return n},this.getPathLines=function(){if(null===n||2>n.length)return [];for(var a=[],b=0;b<n.length-1;b++)a.push(new Line(n[b],n[b+1]));return a},this.getLength=function(){for(var a=0,b=j.getPathLines(),c=0;c<b.length;c++)a+=b[c].getLength();return a},this.getMidpoint=function(){for(var a=j.getLength(),b=j.getPathLines(),c=0,d=null,e=0;e<b.length;e++){d=b[e];var k=b[e].getLength();if(c+=k,c>=a/2)break}var f=c-d.getLength(),g=a/2-f,h=g/d.getLength();return new Point(d.getStartPoint().getX()+h*(d.getEndPoint().getX()-d.getStartPoint().getX()),d.getStartPoint().getY()+h*(d.getEndPoint().getY()-d.getStartPoint().getY()))},this.getMidpointDirection=function(){for(var a=j.getLength(),b=j.getPathLines(),c=0,d=null,e=0;e<b.length;e++){d=b[e];var f=b[e].getLength();if(c+=f,c>=a/2)break}return null===d?b[0].getDirection():d.getDirection()},this.refresh=function(a,b){n=b,o.setAttribute("d",a);},this.getId=function(){var c=[a.getId(),b.getId()].sort();return c.join(":")},this.getAnchorStart=function(){return a},this.getAnchorEnd=function(){return b},this.removePathElement=function(){o.remove();},this.addClassToDomElement=function(a){o.classList.add(a);},this.removeClassFromDomElement=function(a){o.classList.remove(a);},this.getDescriptor=function(){return {id:j.getId(),anchor_start_centroid_arr:a.getCentroid().toArray(),anchor_end_centroid_arr:b.getCentroid().toArray(),marker_start_size:l,marker_end_size:m,curvature_px:f,allow_route_optimization:g,routing_algorithm:h}},this.on=function(a,b){var c=k.get(a)||[];c.push(b),k.set(a,c);},this.off=function(a,b){for(var c=k.get(a)||[],d=0;d<c.length;d++)if(c[d]===b){c.splice(d,1);break}k.set(a,c);},this.dispatchEvent=function(a,b){var c=k.get(a)||[];c.forEach(function(a){a(b);});};}
