var GraphPaper = (function (exports) {
    ...
    var ClosestPairFinder={findClosestPairBetweenObjects:function findClosestPairBetweenObjects(a,b,c){for(var e=a.getConnectorAnchors(),f=b.getConnectorAnchors(),g=0,h=0,i=Number.MAX_VALUE,j=0;j<e.length;j++){var k=e[j].getCentroid(),l=c.get(e[j].getId())||0;if(0!==l)for(var q=0;q<f.length;q++){var m=f[q].getCentroid(),n=Math.sqrt(Math.pow(m.getX()-k.getX(),2)+Math.pow(m.getY()-k.getY(),2)),d=c.get(f[q].getId())||0;n<i&&0<d&&(g=j,h=q,i=n);}}if(i===Number.MAX_VALUE)for(var r,s=0;s<e.length;s++){r=e[s].getCentroid();for(var t=0;t<f.length;t++){var o=f[t].getCentroid(),p=Math.sqrt(Math.pow(o.getX()-r.getX(),2)+Math.pow(o.getY()-r.getY(),2));p<i&&(g=s,h=t,i=p);}}return {objectAAnchorIndex:g,objectAAnchor:e[g],objectBAnchorIndex:h,objectBAnchor:f[h]}}};
    ...
    var SheetEvent=Object.freeze({DBLCLICK:"dblclick",CLICK:"click",CLUSTER_CREATED:"cluster-created",CLUSTER_DELETED:"cluster-deleted",CLUSTER_UPDATED:"cluster-updated",CONNECTOR_UPDATED:"connector-updated",ENTITY_ADDED:"entity-added",ENTITY_REMOVED:"entity-removed",ENTITY_RESIZED:"entity-resized",ENTITY_TRANSLATED:"entity-translated",MULTIPLE_ENTITY_SELECTION_STARTED:"multiple-object-selection-started",MULTIPLE_ENTITIES_SELECTED:"multiple-objects-selected"});
    ...
    function Connector(a,b,c,d,e,f,g){var h=this,j=new Map,k=0,l=0;"undefined"==typeof d&&(d="#000"),"undefined"==typeof e&&(e="2px"),"undefined"==typeof f&&(f=0),"undefined"==typeof g&&(g=ConnectorRoutingAlgorithm.ASTAR_THETA_WITH_ROUTE_OPTIMIZATION);var m=null,n=window.document.createElementNS("http://www.w3.org/2000/svg","path");n.setAttribute("d","M0 0 L0 0"),n.style.stroke=d,n.style.strokeWidth=e;var o=window.document.createElementNS("http://www.w3.org/2000/svg","path");o.setAttribute("d","M0 0 L0 0"),o.style.stroke="transparent",o.style.strokeWidth="12px",o.addEventListener("click",function(a){h.dispatchEvent(ConnectorEvent.CLICK,{connector:h,clickedAtX:a.pageX,clickedAtY:a.pageY});}),o.addEventListener("mouseenter",function(a){h.dispatchEvent(ConnectorEvent.MOUSE_ENTER,{connector:h,pointerAtX:a.pageX,pointerAtY:a.pageY});}),o.addEventListener("mouseleave",function(a){h.dispatchEvent(ConnectorEvent.MOUSE_LEAVE,{connector:h});}),this.appendPathToContainerDomElement=function(){c.appendChild(n),c.appendChild(o);},this.setMarkerStart=function(a,b){n.setAttribute(`marker-start`,`url(${a})`),o.setAttribute(`marker-start`,`url(${a})`),k=b;},this.unsetMarkerStart=function(){n.removeAttribute(`marker-start`),o.removeAttribute(`marker-start`),k=0;},this.setMarkerEnd=function(a,b){n.setAttribute(`marker-end`,`url(${a})`),o.setAttribute(`marker-end`,`url(${a})`),l=b;},this.unsetMarkerEnd=function(){n.removeAttribute(`marker-end`),o.removeAttribute(`marker-end`),l=0;},this.getPathPoints=function(){return m},this.getPathLines=function(){if(null===m||2>m.length)return [];for(var a=[],b=0;b<m.length-1;b++)a.push(new Line(m[b],m[b+1]));return a},this.getLength=function(){for(var a=0,b=h.getPathLines(),c=0;c<b.length;c++)a+=b[c].getLength();return a},this.getMidpoint=function(){for(var a=h.getLength(),b=h.getPathLines(),c=0,d=null,e=0;e<b.length;e++){d=b[e];var k=b[e].getLength();if(c+=k,c>=a/2)break}var f=c-d.getLength(),g=a/2-f,j=g/d.getLength();return new Point(d.getStartPoint().getX()+j*(d.getEndPoint().getX()-d.getStartPoint().getX()),d.getStartPoint().getY()+j*(d.getEndPoint().getY()-d.getStartPoint().getY()))},this.getMidpointDirection=function(){for(var a=h.getLength(),b=h.getPathLines(),c=0,d=null,e=0;e<b.length;e++){d=b[e];var f=b[e].getLength();if(c+=f,c>=a/2)break}return null===d?b[0].getDirection():d.getDirection()},this.refresh=function(a){n.setAttribute("d",a),o.setAttribute("d",a);},this.updatePathPoints=function(a){m=a;},this.getId=function(){var c=[a.getId(),b.getId()].sort();return c.join(":")},this.getAnchorStart=function(){return a},this.getAnchorEnd=function(){return b},this.removePathElement=function(){n.remove(),o.remove();},this.addClassToDomElement=function(a){n.classList.add(a);},this.removeClassFromDomElement=function(a){n.classList.remove(a);},this.getDescriptor=function(){return {id:h.getId(),anchor_start_centroid_arr:a.getCentroid().toArray(),anchor_end_centroid_arr:b.getCentroid().toArray(),marker_start_size:k,marker_end_size:l,curvature_px:f,routing_algorithm:g}},this.on=function(a,b){var c=j.get(a)||[];c.push(b),j.set(a,c);},this.off=function(a,b){for(var c=j.get(a)||[],d=0;d<c.length;d++)if(c[d]===b){c.splice(d,1);break}j.set(a,c);},this.dispatchEvent=function(a,b){var c=j.get(a)||[];c.forEach(function(a){a(b);});};}
