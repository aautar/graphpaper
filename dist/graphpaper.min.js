...
function GroupTransformationContainer(a,b,c){var d=this,f=new Map,g=a.calcBoundingRectForObjects(b),h=0,j=0,k=g.getLeft(),l=g.getTop(),m=[];b.forEach(function(a){var b={x:a.getX()-k,y:a.getY()-l};m.push(b);});var n=window.document.createElement("div");n.classList.add("ia-group-transformation-container"), n.style.display="block", n.style.position="absolute", n.style.left=`${k}px`, n.style.top=`${l}px`, n.style.width=`${g.getWidth()}px`, n.style.height=`${g.getHeight()}px`, "undefined"==typeof c||0===c.length?(n.style.border="1px solid rgb(158, 158, 158)", n.style.backgroundColor="rgba(153, 153, 153, 0.5)"):c.forEach(function(a){n.classList.add(a);}), this.getContainerDomElement=function(){return n}, this.getObjects=function(){return b}, this.translateByOffset=function(c,d){h+=c, j+=d, k=a.snapToGrid(g.getLeft()+h), l=a.snapToGrid(g.getTop()+j), n.style.left=`${k}px`, n.style.top=`${l}px`;for(var o=0;o<b.length;o++){var e=b[o],f=m[o];e.translate(a.snapToGrid(k+f.x),a.snapToGrid(l+f.y));}}, this.endTranslate=function(){h=0, j=0, g=a.calcBoundingRectForObjects(b);}, this.initTranslateInteractionHandler=function(){n.addEventListener("touchstart",o), n.addEventListener("mousedown",p);}, this.on=function(a,b){var c=f.get(a)||[];c.push(b), f.set(a,c);}, this.off=function(a,b){for(var c=f.get(a)||[],d=0;d<c.length;d++)if(c[d]===b){c.splice(d,1);break}f.set(a,c);};var o=function translateTouchStartHandler(a){var b=f.get(GroupTransformationContainerEvent.TRANSLATE_START)||[];b.forEach(function(b){b({container:d,x:a.touches[0].pageX,y:a.touches[0].pageY,isTouch:!0});});},p=function translateMouseDownHandler(a){var b=f.get(GroupTransformationContainerEvent.TRANSLATE_START)||[];b.forEach(function(b){b({container:d,x:a.pageX,y:a.pageY,isTouch:!1});});};}
