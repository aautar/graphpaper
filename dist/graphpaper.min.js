var GraphPaper = (function (exports) {
    ...
    var AccessibleRoutingPointsFinder={find:function find(a,b,c){var d=new Map,e=[],f=new PointSet;return a.forEach(function(a){var b=a.getConnectorAnchors();b.forEach(function(b){{var g=b.getRoutingPoints(c);g.forEach(function(c){e.push({routingPoint:c,parentAnchor:b,parentEntity:a});}),d.set(b.getId(),g.length);}});}),e.forEach(function(a){for(var c=!1,e=0;e<b.length;e++){var g=b[e],h=g.getBoundingRectange();if(h.checkIsPointWithin(a.routingPoint)){c=!0;var j=d.get(a.parentAnchor.getId())||0;d.set(a.parentAnchor.getId(),j-1);}}c||f.push(a.routingPoint);}),{connectorAnchorToNumValidRoutingPoints:d,accessibleRoutingPoints:f}}};
    ...
    var DebugMetricsPanel=function DebugMetricsPanel(a){var b=null,c=!1;this.init=function(){b=a.document.createElement("div"),b.classList.add("graphpaper-debug-panel"),b.style.display="none",b.style.position="fixed",b.style.right="0px",b.style.top="0px",b.style.width="450px",b.style.height="200px",b.style.color="#fff",b.style.padding="15px",b.style.backgroundColor="rgba(0,0,0,0.75)",a.document.body.appendChild(b);},this.show=function(){c=!0,b.style.display="block";},this.hide=function(){c=!1,b.style.display="none";},this.refresh=function(a){!1===c||(b.innerHTML=`
            ...
            <p>-- refreshAllConnectorsInternal.accessibleRoutingPointsFinder = ${a.refreshAllConnectorsInternal.accessibleRoutingPointsFinder}</p>
