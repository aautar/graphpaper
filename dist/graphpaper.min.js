var GraphPaper = (function (exports) {
    ...
    var AccessibleRoutingPointsFinder={find:function find(a,b,c){var d=new Map,e=[],f=[];return a.forEach(function(a){var b=a.getConnectorAnchors();b.forEach(function(a){var b=a.getRoutingPoints(c);b.forEach(function(b){e.push({routingPoint:b,parentAnchor:a});}),d.set(a.getId(),b.length);});}),e.forEach(function(a){for(var c=!1,e=0;e<b.length;e++){var g=b[e],h=g.getBoundingRectange();if(h.checkIsPointWithin(a.routingPoint)){c=!0;var j=d.get(a.parentAnchor.getId())||0;d.set(a.parentAnchor.getId(),j-1);}}c||f.push(a.routingPoint);}),{connectorAnchorToNumValidRoutingPoints:d,accessibleRoutingPoints:f}}};
